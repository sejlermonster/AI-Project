...
\definecolor{ThemeColor}{RGB}{244, 146, 66} % Blue
...
\begin{document}
	...
	\include{chapter/Localization}
	\include{chapter/KalmanFilter}
	\include{chapter/ParticleFilter}
	\include{chapter/Search}
	\include{chapter/PID}
	\include{chapter/SLAM}

    \include{chapter/project}
%    \include{chapter/SystemDescription}
    \include{chapter/Implementation}
    \include{chapter/Resultater}
